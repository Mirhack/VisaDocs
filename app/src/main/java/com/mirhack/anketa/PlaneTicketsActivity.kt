...
class PlaneTicketsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnNextStep.setOnClickListener {
            ...
            editor.putStringSet("plane", images)
